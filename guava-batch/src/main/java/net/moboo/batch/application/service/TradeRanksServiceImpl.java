...
//import net.moboo.batch.common.utils.DoubleUtils;
//import net.moboo.batch.domain.Region;
//import net.moboo.batch.domain.RegionType;
//import net.moboo.batch.domain.Trade;
//import net.moboo.batch.domain.TradeRanks;
//import net.moboo.batch.infrastructure.jpa.RegionRepository;
//import net.moboo.batch.infrastructure.jpa.TradeRanksRepository;
//import net.moboo.batch.infrastructure.jpa.TradeRepository;
