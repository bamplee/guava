...
//        LIKESGREATERTHAN("likes");
    ...
    public static Specification<RentSummary> withTitle(String title) {
        return (Specification<RentSummary>) ((root, query, builder) ->
            builder.equal(root.get("title"), title)
        );
    }

    public static Specification<RentSummary> searchWith(Map<SearchKey, Object> searchKeyword) {
        return (Specification<RentSummary>) ((root, query, builder) -> {
