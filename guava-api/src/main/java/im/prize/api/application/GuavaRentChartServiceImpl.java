...
@Service
public class GuavaRentChartServiceImpl implements GuavaRentChartService {
    ...
    public List<GuavaChartResponse> getRegionChartList(String regionId,
        ...
        if (optionalGuavaRegion.isPresent()) {
            ...
            List<RentSummary> tradeSummaryPage = tradeSummaryRepository.findAll(this.getParams(guavaRegion.getValidRegionCode(),
                                                                                                null,
                                                                                                null,
                                                                                                startDate, endDate));
...
//                                   .peek(x -> x.setBuildingId(buildingId))
    ...
    public List<GuavaChartResponse> getChartList(String buildingCode, String areaId, String startDate, String endDate) {
        ...
        if (optionalBuildingMapping.isPresent()) {
            ...
            List<RentSummary> tradeSummaryPage = tradeSummaryRepository.findAll(this.getParams(null,
...
//                                   .peek(x -> x.setBuildingId(buildingId))
    ...
    private Specification<RentSummary> getParams(String regionCode,
                                                  String buildingCode,
                                                  String areaCode,
                                                  String startDate,
                                                  String endDate) {
