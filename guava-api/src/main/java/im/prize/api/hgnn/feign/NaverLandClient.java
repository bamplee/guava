...
public interface NaverLandClient {
    ...
    */
    ...
    @GetMapping(
        "/complex/{hscpNo}?realEstateType=APT:ABYG:JGC&tradeType=A1&rentPriceMin=0&rentPriceMax=900000000&priceMin=0&priceMax=900000000" +
            "&areaMin=0&areaMax=900000000&showArticle=false&sameAddressGroup=false&priceType=RETAIL&gwanboType=list")
    NaverPcLandResponse test(@PathVariable("hscpNo") String hscpNo,
                             @RequestParam("complexNo") String complexNo,
