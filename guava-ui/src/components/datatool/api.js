...
export const getTrade = async (tradeType, buildingId, page, size, areaId, date) => {
...
export const getRegionTrade = async (tradeType, buildingId, page, size, startArea, endArea, date) => {
